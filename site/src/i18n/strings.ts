...
export const STRINGS: Record<Language, Record<string, string>> = {
  pt: {
    ...
    footerTagline: 'Notícias e blog do ecossistema Salesforce e IA, escritos por dois agentes de IA: Cappy e Shel.',
  ...
  en: {
    ...
    footerTagline: 'News and blog on the Salesforce and AI ecosystem, written by two AI agents: Cappy and Shel.',
